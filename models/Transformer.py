...
class EncoderDecoder(nn.Module):
    ...
    """
    def __init__(self,encoder, decoder, scr_embed, tgt_embed, generator):
        """
        :param encoder:
        :param decoder:
        :param src_embed: 输入维度[batch,channel,H,W]--->输出维度[batch,H*W,channel->d_model] [5,3,32,100]->[5,14,256]
        :param tgt_embed:
        :param generator:
        """
        ...
        self.src_embed = scr_embed  #特征提取+位置编码
        self.tgt_embed = tgt_embed  #Embedding+位置编码
